...
<table style={{width: "100%", borderCollapse: "collapse", tableLayout: "fixed"}}>
  ...
  <tbody>
    ...
    <tr>
      <td style={{padding: "9px 12px", fontWeight: 500, backgroundColor: "rgba(255,255,255,0.02)"}}>**SmolLM3** (3B)</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.05)"}}>`HuggingFaceTB/SmolLM3-3B`</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.02)"}}>Hugging Face's 3B model with NoPE layers interleaved every 4th layer for improved long-context extrapolation; competitive with larger dense models on reasoning benchmarks.</td>
    </tr>
    <tr>
